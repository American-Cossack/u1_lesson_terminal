...
Please note that this class, and this field as a whole, are moving in a Mac-centric direction. It will be possible to go through these lessons with a PC using GitBash, Linux, and Ubuntu, but there may be some additional steps needed at each point.
